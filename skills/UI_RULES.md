...
│      │                                  │                     │
│ Left │   Custom Node Canvas             │  Inspector Panel    │
│ Side │   (nodeEditor)                   │                     │
│ bar  │                                  │                     │
│      │                                  │                     │
│      │                                  │                     │
...
| 동작 | 결과 |
|---|---|
| 단일 클릭 | nodeEditor.selectedNode 갱신 → Inspector에 해당 노드 표시 |
...
┌───────────────────────────────────────────────────────┐
│ History                                               │
│ Hint: You can get more details about generated        │
│    image by clicking on the image                     │
├───┬───┬───┬───┬───┬───┬───────────────────────────────┤
│   │   │   │   │   │   │                               │
│img│img│img│img│img│img│  결과 이미지 그리드              │
│   │   │   │   │   │   │                               │
...
- 커스텀 드래그/줌 (transform 기반)
- 마우스 드래그: 캔버스 팬 이동
- 마우스 휠: 캔버스 줌 인/아웃
- 줌 범위: 0.1x ~ 3.0x
- nodeEditor 전역 객체에서 transform 상태 관리

---

## 비디오 노드 재생

- VIDEO 노드 결과가 있는 경우: 노드에 재생 오버레이 표시
